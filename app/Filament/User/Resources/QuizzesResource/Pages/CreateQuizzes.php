...
class CreateQuizzes extends CreateRecord
{
    ...
    protected function handleRecordCreation(array $data): Model
    {
        ...
        // Create quiz without AI generation
        $quiz = Quiz::create($input);

        Notification::make()
            ->success()
            ->title(__('messages.quiz.quiz_created_success'))
            ->body('Quiz created successfully. Please add questions manually using the edit page.')
            ->send();
